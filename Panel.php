...
.sg-preview-masonry .sg-img-item {
    aspect-ratio: auto;
    margin-bottom: 15px;
}
.sg-img-item:active {
...
.local-browser-header .breadcrumb {
    flex: 1;
    font-size: 14px;
    color: #666;
    min-width: 150px;
}
.local-browser-header .breadcrumb span {
    cursor: pointer;
    color: #467B96;
}
.local-folders {
...
.sg-layout-toggle button.active {
    background: #467B96;
    color: #fff;
    border-color: #467B96;
}
        ...
        <div class="sg-modal-body">
            ...
            <div class="sg-toolbar">
                ...
                <div class="sg-toolbar-right">
                    ...
                    <button class="sg-btn external" onclick="openExternalModal()">外链</button>
...
<!-- 外链弹窗 -->
<div id="external-modal" class="sg-modal-overlay">
    <div class="sg-modal-content" style="max-width: 600px;">
        <div class="sg-modal-header">
            <h3>添加外链图片/视频</h3>
            <button onclick="closeModal('external-modal')">&times;</button>
        </div>
        <div class="sg-modal-body">
